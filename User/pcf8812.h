...
#define PCF8812_YSIZE               8//vertical banks(each contains 8 pixels)
...
__IO uint8_t PCF8812_buff_state;
...
static const char lcd_font[][5] =
{
	...
	{ 0x7E, 0x02, 0x02, 0x02, 0x03 },  // 165 РўС’
  { 0x00, 0x00, 0x00, 0x00, 0x00 },
  { 0x00, 0x00, 0x00, 0x00, 0x00 },
  { 0x7C, 0x55, 0x54, 0x55, 0x44 },  // 168 Р Рѓ
  { 0x00, 0x00, 0x00, 0x00, 0x00 },
  { 0x3E, 0x49, 0x49, 0x49, 0x41 },  // 170 Р вЂћ
  { 0x00, 0x00, 0x00, 0x00, 0x00 },
  { 0x00, 0x00, 0x00, 0x00, 0x00 },
  { 0x00, 0x00, 0x00, 0x00, 0x00 },
  { 0x00, 0x00, 0x00, 0x00, 0x00 },
  { 0x00, 0x45, 0x7C, 0x45, 0x00 },  // 175 Р вЂЎ
  { 0x00, 0x00, 0x00, 0x00, 0x00 },
  { 0x00, 0x00, 0x00, 0x00, 0x00 },
  { 0x00, 0x41, 0x7F, 0x41, 0x00 },  // 178 Р вЂ 
  { 0x00, 0x44, 0x7D, 0x40, 0x00 },  // 179 РЎвЂ“
  { 0x7C, 0x04, 0x04, 0x04, 0x06 },  // 180 РўвЂ�
  { 0x00, 0x00, 0x00, 0x00, 0x00 },
  { 0x00, 0x00, 0x00, 0x00, 0x00 },
  { 0x00, 0x00, 0x00, 0x00, 0x00 },
  { 0x38, 0x55, 0x54, 0x55, 0x18 },  // 184 РЎвЂ�
  { 0x00, 0x00, 0x00, 0x00, 0x00 },
  { 0x38, 0x54, 0x54, 0x54, 0x44 },  // 186 РЎвЂќ
  { 0x00, 0x00, 0x00, 0x00, 0x00 },
  { 0x00, 0x00, 0x00, 0x00, 0x00 },
  { 0x00, 0x00, 0x00, 0x00, 0x00 },
  { 0x00, 0x00, 0x00, 0x00, 0x00 },
  { 0x00, 0x45, 0x7C, 0x41, 0x00 },  // 191 РЎвЂ”


	{ 0x7E, 0x11, 0x11, 0x11, 0x7E },  // Р С’ (192)
	{ 0x7F, 0x49, 0x49, 0x49, 0x33 },  // Р вЂ�
	{ 0x7F, 0x49, 0x49, 0x49, 0x36 },  // Р вЂ™
	{ 0x7F, 0x01, 0x01, 0x01, 0x03 },  // Р вЂњ
	{ 0xE0, 0x51, 0x4F, 0x41, 0xFF },  // Р вЂќ
	{ 0x7F, 0x49, 0x49, 0x49, 0x49 },  // Р вЂў
	{ 0x77, 0x08, 0x7F, 0x08, 0x77 },  // Р вЂ“
	{ 0x49, 0x49, 0x49, 0x49, 0x36 },  // Р вЂ”
	{ 0x7F, 0x10, 0x08, 0x04, 0x7F },  // Р пїЅ
	{ 0x7C, 0x21, 0x12, 0x09, 0x7C },  // Р в„ў
	{ 0x7F, 0x08, 0x14, 0x22, 0x41 },  // Р С™
	{ 0x20, 0x41, 0x3F, 0x01, 0x7F },  // Р вЂє
	{ 0x7F, 0x02, 0x0C, 0x02, 0x7F },  // Р Сљ
	{ 0x7F, 0x08, 0x08, 0x08, 0x7F },  // Р Сњ
	{ 0x3E, 0x41, 0x41, 0x41, 0x3E },  // Р С›
	{ 0x7F, 0x01, 0x01, 0x01, 0x7F },  // Р Сџ
	{ 0x7F, 0x09, 0x09, 0x09, 0x06 },  // Р В Р’В 
	{ 0x3E, 0x41, 0x41, 0x41, 0x22 },  // Р РЋ
	{ 0x01, 0x01, 0x7F, 0x01, 0x01 },  // Р Сћ
	{ 0x27, 0x48, 0x48, 0x48, 0x3F },  // Р Р€
	{ 0x1C, 0x22, 0x7F, 0x22, 0x1C },  // Р В¤
	{ 0x63, 0x14, 0x08, 0x14, 0x63 },  // Р Тђ
	{ 0x7F, 0x40, 0x40, 0x40, 0xFF },  // Р В¦
	{ 0x07, 0x08, 0x08, 0x08, 0x7F },  // Р В§
	{ 0x7F, 0x40, 0x7F, 0x40, 0x7F },  // Р РЃ
	{ 0x7F, 0x40, 0x7F, 0x40, 0xFF },  // Р В©
	{ 0x01, 0x7F, 0x48, 0x48, 0x30 },  // Р Р„
	{ 0x7F, 0x48, 0x30, 0x00, 0x7F },  // Р В«
	{ 0x7F, 0x48, 0x48, 0x30, 0x00 },  // Р В¬
	{ 0x22, 0x41, 0x49, 0x49, 0x3E },  // Р В­
	{ 0x7F, 0x08, 0x3E, 0x41, 0x3E },  // Р В®
	{ 0x46, 0x29, 0x19, 0x09, 0x7F },  // Р Р‡
	{ 0x20, 0x54, 0x54, 0x54, 0x78 },  // Р В°
	{ 0x3C, 0x4A, 0x4A, 0x49, 0x31 },  // Р В±
	{ 0x7C, 0x54, 0x54, 0x28, 0x00 },  // Р Р†
	{ 0x7C, 0x04, 0x04, 0x04, 0x0C },  // Р С–
	{ 0xE0, 0x54, 0x4C, 0x44, 0xFC },  // Р Т‘
	{ 0x38, 0x54, 0x54, 0x54, 0x08 },  // Р Вµ
	{ 0x6C, 0x10, 0x7C, 0x10, 0x6C },  // Р В¶
	{ 0x44, 0x44, 0x54, 0x54, 0x28 },  // Р В·
	{ 0x7C, 0x20, 0x10, 0x08, 0x7C },  // Р С‘
	{ 0x78, 0x42, 0x24, 0x12, 0x78 },  // Р в„–
	{ 0x7C, 0x10, 0x28, 0x44, 0x00 },  // Р С”
	{ 0x20, 0x44, 0x3C, 0x04, 0x7C },  // Р В»
	{ 0x7C, 0x08, 0x10, 0x08, 0x7C },  // Р С�
	{ 0x7C, 0x10, 0x10, 0x10, 0x7C },  // Р Р…
	{ 0x38, 0x44, 0x44, 0x44, 0x38 },  // Р С•
	{ 0x7C, 0x04, 0x04, 0x04, 0x7C },  // Р С—
	{ 0x7C, 0x14, 0x14, 0x14, 0x08 },  // РЎР‚
	{ 0x38, 0x44, 0x44, 0x44, 0x44 },  // РЎРѓ
	{ 0x04, 0x04, 0x7C, 0x04, 0x04 },  // РЎвЂљ
	{ 0x0C, 0x50, 0x50, 0x50, 0x3C },  // РЎС“
	{ 0x18, 0x24, 0x7E, 0x24, 0x18 },  // РЎвЂћ
	{ 0x44, 0x28, 0x10, 0x28, 0x44 },  // РЎвЂ¦
	{ 0x7C, 0x40, 0x40, 0x40, 0xFC },  // РЎвЂ 
	{ 0x0C, 0x10, 0x10, 0x10, 0x7C },  // РЎвЂЎ
	{ 0x7C, 0x40, 0x7C, 0x40, 0x7C },  // РЎв‚¬
	{ 0x7C, 0x40, 0x7C, 0x40, 0xFC },  // РЎвЂ°
	{ 0x04, 0x7C, 0x50, 0x50, 0x20 },  // РЎР‰
	{ 0x7C, 0x50, 0x20, 0x00, 0x7C },  // РЎвЂ№
	{ 0x7C, 0x50, 0x50, 0x20, 0x00 },  // РЎРЉ
	{ 0x28, 0x44, 0x54, 0x54, 0x38 },  // РЎРЊ
	{ 0x7C, 0x10, 0x38, 0x44, 0x38 },  // РЎР‹
	{ 0x08, 0x54, 0x34, 0x14, 0x7C },  // РЎРЏ (255)
};
